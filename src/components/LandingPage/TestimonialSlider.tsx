  ...
  return (
    <div>
      <div className="mb-[40px] space-x-10">
        <button
          className={`rounded-full text-[#0D1259] ${
            isBeginning && `text-white`
          } ${
            isBeginning ? `bg-[#434de0]` : `bg-white `
          } border border-[#1090D2] p-[16px]`}
        ...
        <button
          className={`rounded-full text-[#0D1259]  ${isEnd && `text-white`} ${
            isEnd ? `bg-[#434de0]` : `bg-white `
          } border border-[#1090D2] p-[16px]`}
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center">
                {image === "" ? (
                  <div className="rounded-full p-4 text-white text-xl font-bold px-6 bg-[#515AE5]">
                    {name.charAt(0).toUpperCase()}
                  </div>
                ) : (
                  <img src={image} alt="image" />
                )}
                <p className="font-[600] leading-[24px] text-[18px] text-[#0D1259] ml-[16px]">
                  {name}
                </p>
              </div>
              {/* rating */}
