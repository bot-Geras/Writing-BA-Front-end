    ...
    <div className="flex items-center mx-auto h-screen w-4/5 xl:w-[40%] xl:ml-auto xl:mr-0">
      <div className="container h-[95%]">
        <div className=" h-[95%]">
          ...
          />
          <div className="">
            <h2 className="xl:max-w-[223px] md:text-left mb-[16px] font-[700] text-5xl md:text-[56px] md:leading-[64px] text-[#0D1259]">
              Login
            </h2>
          </div>
          <div className=" mt-10">
          ...
          <div className="text-left mt-6 text-[#515AE5] hover:underline">
          ...
          <div className=" mt-14 flex flex-col md:flex md:flex-row justify-between xl:w-[70%]">
            <Link
              to=""
